...
- b6b8137: fix(@liteforge/runtime): replace requestAnimationFrame with queueMicrotask in Show deferred path
  ...
  `requestAnimationFrame`. Since rAF fires _after_ the browser's next paint, there was
